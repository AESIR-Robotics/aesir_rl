...
def main():
    ...
    parser.add_argument("xml_path", help="Ruta al XML de MuJoCo (ej. solo_pallets.xml)")
    ...
    parser.add_argument("--out-raw", type=str, default="occupied_map.bt")
    parser.add_argument("--out-inflated", type=str, default="inflated_map.bt")
