...
if __name__ == "__main__":
    ...
    parser.add_argument("bt_path", help="Ruta al archivo .bt (occupied_map.bt o inflated_map.bt)")
    ...
    print(f"📥 Leyendo octomap: {args.bt_path}")
    elevation, origin, res, z_min, z_max = octree_to_global_elevation(
        args.bt_path, resolution=args.resolution, margin=args.margin
    )
